...
# Test: model_gemm.py
# OV_GPU_DumpLayersRaw=1 OV_GPU_DumpLayersPath=./output_binary/ OV_GPU_Verbose=4 
ONEDNN_VERBOSE=1 numactl -C 0-31 $GDB python model_gemm.py

# source ../../openvino/build_gcc/install/setupvars.sh # Your OV Env.
# numactl -C 0-15 $GDB python model_gemm.py
